...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 3f5abce7-2f0b-4f08-9941-185a205df2ac
```

> `3f5abce7-2f0b-4f08-9941-185a205df2ac` is the password of the certificate, you can change it to any password you want.
